...
window.STUDY_CATALOG = {
  ...
  resources: [
    ...
    { title: "Grade 6 Graphs of Functions", category: "math", url: "tools/math/graphs-of-functions-grade-6/", description: "Read straight-line graphs, match x and y values, and solve word problems using graphed functions.", type: "Study guide and quiz" },
    ...
    { title: "Claim, Evidence & Reasoning Lab", category: "science", url: "tools/science/claim-evidence-reasoning-lab/", description: "Practice writing If/Then/Because hypotheses and Claim/Evidence/Reasoning conclusions with fresh experiment scenarios.", type: "Study guide and practice" },
    ...
    { title: "Sentence Types Lab", category: "writing", url: "tools/writing/sentence-types-lab/", description: "Practice argument structure and identify simple, compound, complex, and compound-complex sentences.", type: "Study guide and practice" },
